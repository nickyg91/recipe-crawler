...
namespace RecipeCrawler.Data.Migrations
{
    ...
    [Migration("20230412004127_AddUseIdentityToIdColumns")]
    partial class AddUseIdentityToIdColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RecipeCrawler.Entities.Chef", b =>
                {
                    ...
                    b.Property<Guid?>("EmailVerificationGuid")
                        ...
                        .HasMaxLength(64)
                        .HasColumnType("uuid")
                        .HasDefaultValue(new Guid("91ef49cc-bfbf-47ac-8e20-d8f79989fe4b"))
